folder = '/home/aneesh/UbuntuStorage/Homework/MMT/SonusTexere/dune/DuneOST/';
...
%    segments = get(sp, 'FramePos');
    ...
    saveFileName = ['/home/aneesh/UbuntuStorage/Homework/MMT/SonusTexere/dune/segmentedAudio_step2/', erase(song_name, '.mp3'), '.mat'];
